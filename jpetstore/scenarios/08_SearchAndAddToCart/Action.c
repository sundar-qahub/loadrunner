Action()
{
	...
	if (atoi(lr_eval_string("{01_Count}")) > 0) {
		lr_end_transaction("08_SearchAndAddToCart_01_Launch", LR_PASS);
	} else {
		lr_end_transaction("08_SearchAndAddToCart_01_Launch", LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{02_Count}")) > 0) {
		lr_end_transaction("08_SearchAndAddToCart_02_EnterTheStore",LR_PASS);
	} else {
		lr_end_transaction("08_SearchAndAddToCart_02_EnterTheStore",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{03_Count}")) > 0) {
		lr_end_transaction("08_SearchAndAddToCart_03_ClickSignIn",LR_PASS);
	} else {
		lr_end_transaction("08_SearchAndAddToCart_03_ClickSignIn",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{04_Count}")) > 0) {
		lr_end_transaction("08_SearchAndAddToCart_04_ClickLogin",LR_PASS);
	} else {
		lr_end_transaction("08_SearchAndAddToCart_04_ClickLogin",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{05_Count}")) > 0) {
		lr_end_transaction("08_SearchAndAddToCart_05_EnterProductInSearchBox",LR_PASS);
	} else {
		lr_end_transaction("08_SearchAndAddToCart_05_EnterProductInSearchBox",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{06_Count}")) > 0) {
		lr_end_transaction("08_SearchAndAddToCart_06_SelectProductFromSearchResult",LR_PASS);
	} else {
		lr_end_transaction("08_SearchAndAddToCart_06_SelectProductFromSearchResult",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{07_Count}")) > 0) {
		lr_end_transaction("08_SearchAndAddToCart_07_AddPetitemToCart",LR_PASS);
	} else {
		lr_end_transaction("08_SearchAndAddToCart_07_AddPetitemToCart",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{08_Count}")) > 0) {
		lr_end_transaction("08_SearchAndAddToCart_08_SignOut",LR_PASS);
	} else {
		lr_end_transaction("08_SearchAndAddToCart_08_SignOut",LR_FAIL);
	}
