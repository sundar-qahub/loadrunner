Action()
{
	...
	if (atoi(lr_eval_string("{01_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_01_Launch",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_01_Launch",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{02_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_02_EnterTheStore",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_02_EnterTheStore",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{03_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_03_ClickSignIn",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_03_ClickSignIn",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{04_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_04_ClickLogin",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_04_ClickLogin",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{05_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_05_EnterProductInSearchBox",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_05_EnterProductInSearchBox",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{06_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_06_SelectProductFromSearchResult",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_06_SelectProductFromSearchResult",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{07_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_07_AddPetitemToCart",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_07_AddPetitemToCart",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{08_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_08_UpdateRandomQuantityAndUpdateCart",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_08_UpdateRandomQuantityAndUpdateCart",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{09_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_09_ProceedToCheckout",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_09_ProceedToCheckout",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{10_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_10_EnterPaymentDetailsAndContinue",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_10_EnterPaymentDetailsAndContinue",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{11_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_11_ConfirmTheOrder",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_11_ConfirmTheOrder",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{12_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_12_SignOut",LR_PASS);
	} else {
		lr_end_transaction("07_SearchAndBuy_12_SignOut",LR_FAIL);
	}
