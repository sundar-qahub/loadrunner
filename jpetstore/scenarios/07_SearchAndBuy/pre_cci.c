# 1 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\07_searchandbuy\\\\combined_07_SearchAndBuy.c"
...
# 1 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\07_searchandbuy\\\\combined_07_SearchAndBuy.c" 2
...
# 2 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\07_searchandbuy\\\\combined_07_SearchAndBuy.c" 2
...
# 3 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\07_searchandbuy\\\\combined_07_SearchAndBuy.c" 2
...
# 4 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\07_searchandbuy\\\\combined_07_SearchAndBuy.c" 2
...
Action()
{
	...
	lr_start_transaction("07_SearchAndBuy_01_Launch");
	...
	if (atoi(lr_eval_string("{01_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_01_Launch",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_01_Launch",1);
	}
	...
	lr_start_transaction("07_SearchAndBuy_02_EnterTheStore");
	...
	if (atoi(lr_eval_string("{02_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_02_EnterTheStore",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_02_EnterTheStore",1);
	}
	...
	lr_start_transaction("07_SearchAndBuy_03_ClickSignIn");
	...
	if (atoi(lr_eval_string("{03_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_03_ClickSignIn",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_03_ClickSignIn",1);
	}
	...
	lr_start_transaction("07_SearchAndBuy_04_ClickLogin");
	...
	if (atoi(lr_eval_string("{04_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_04_ClickLogin",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_04_ClickLogin",1);
	}
	...
	lr_start_transaction("07_SearchAndBuy_05_EnterProductInSearchBox");

	web_submit_data("5", 
		"Action={p_url}/actions/Catalog.action", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=text/html", 
		"Referer={p_url}/actions/Catalog.action", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=keyword", "Value={p_productName}", "ENDITEM", 
		"Name=searchProducts", "Value=Search", "ENDITEM", 
		"Name=_sourcePage", "Value={c_sourcepage_04}", "ENDITEM", 
		"Name=__fp", "Value={c_fp}", "ENDITEM", 
		"LAST");
	
	if (atoi(lr_eval_string("{05_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_05_EnterProductInSearchBox",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_05_EnterProductInSearchBox",1);
	}
	...
	lr_start_transaction("07_SearchAndBuy_06_SelectProductFromSearchResult");
	...
	if (atoi(lr_eval_string("{06_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_06_SelectProductFromSearchResult",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_06_SelectProductFromSearchResult",1);
	}
	...
	lr_start_transaction("07_SearchAndBuy_07_AddPetitemToCart");
	...
	if (atoi(lr_eval_string("{07_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_07_AddPetitemToCart",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_07_AddPetitemToCart",1);
	}

	lr_think_time(4);

	web_reg_find("Text=Quantity", "SaveCount=08_Count", "LAST");
	lr_start_transaction("07_SearchAndBuy_08_UpdateRandomQuantityAndUpdateCart");
	...
	if (atoi(lr_eval_string("{08_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_08_UpdateRandomQuantityAndUpdateCart",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_08_UpdateRandomQuantityAndUpdateCart",1);
	}
	...
	lr_start_transaction("07_SearchAndBuy_09_ProceedToCheckout");
	...
	if (atoi(lr_eval_string("{09_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_09_ProceedToCheckout",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_09_ProceedToCheckout",1);
	}

	lr_think_time(4);

	lr_start_transaction("07_SearchAndBuy_10_EnterPaymentDetailsAndContinue");
	...
	if (atoi(lr_eval_string("{10_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_10_EnterPaymentDetailsAndContinue",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_10_EnterPaymentDetailsAndContinue",1);
	}
	...
	lr_start_transaction("07_SearchAndBuy_11_ConfirmTheOrder");
	...
	if (atoi(lr_eval_string("{11_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_11_ConfirmTheOrder",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_11_ConfirmTheOrder",1);
	}
	...
	lr_start_transaction("07_SearchAndBuy_12_SignOut");
	...
	if (atoi(lr_eval_string("{12_Count}")) > 0) {
		lr_end_transaction("07_SearchAndBuy_12_SignOut",0);
	} else {
		lr_end_transaction("07_SearchAndBuy_12_SignOut",1);
	}
	
	lr_think_time(4);
	return 0;
}
# 5 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\07_searchandbuy\\\\combined_07_SearchAndBuy.c" 2
...
# 6 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\07_searchandbuy\\\\combined_07_SearchAndBuy.c" 2
