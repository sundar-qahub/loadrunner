# 1 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\06_buymultiplepets\\\\combined_06_BuyMultiplePets.c"
...
# 1 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\06_buymultiplepets\\\\combined_06_BuyMultiplePets.c" 2
...
# 2 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\06_buymultiplepets\\\\combined_06_BuyMultiplePets.c" 2
...
# 3 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\06_buymultiplepets\\\\combined_06_BuyMultiplePets.c" 2
...
# 4 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\06_buymultiplepets\\\\combined_06_BuyMultiplePets.c" 2
...
Action()
{
	...
	if (atoi(lr_eval_string("{01_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_01_Launch",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_01_Launch",1);
	}
	...
	if (atoi(lr_eval_string("{02_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_02_EnterTheStore",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_02_EnterTheStore",1);
	}
	...
	if (atoi(lr_eval_string("{03_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_03_ClickSignIn",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_03_ClickSignIn",1);
	}
	...
	if (atoi(lr_eval_string("{04_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_04_ClickLogin",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_04_ClickLogin",1);
	}
	...
	if (atoi(lr_eval_string("{05_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_05_ClickPet1",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_05_ClickPet1",1);
	}
	...
	if (atoi(lr_eval_string("{06_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_06_SelectPet1Product",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_06_SelectPet1Product",1);
	}
	...
	if (atoi(lr_eval_string("{07_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_07_ClickAddToCartPet1Item",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_07_ClickAddToCartPet1Item",1);
	}
	...
	if (atoi(lr_eval_string("{08_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_08_UpdateRandomQuantityAndUpdateCart",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_08_UpdateRandomQuantityAndUpdateCart",1);
	}
	...
	if (atoi(lr_eval_string("{09_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_09_ReturnToMainMenu",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_09_ReturnToMainMenu",1);
	}
	...
	if (atoi(lr_eval_string("{10_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_10_SelectPet2",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_10_SelectPet2",1);
	}
	...
	if (atoi(lr_eval_string("{11_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_11_SelectPet2Product",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_11_SelectPet2Product",1);
	}
	...
	if (atoi(lr_eval_string("{12_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_12_AddToCartPet2Item",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_12_AddToCartPet2Item",1);
	}
	...
	if (atoi(lr_eval_string("{13_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_13_UpdateRandomQuanityPet2ItemAndUpdateCart",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_13_UpdateRandomQuanityPet2ItemAndUpdateCart",1);
	}
	...
	if (atoi(lr_eval_string("{14_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_14_ProceedToCheckOut",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_14_ProceedToCheckOut",1);
	}
	...
	if (atoi(lr_eval_string("{15_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_15_EnterPaymentDetailsAndContinue",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_15_EnterPaymentDetailsAndContinue",1);
	}
	...
	if (atoi(lr_eval_string("{16_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_16_ConfirmTheOrder",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_16_ConfirmTheOrder",1);
	}
	...
	if (atoi(lr_eval_string("{17_Count}")) > 0) {
		lr_end_transaction("06_BuyMultiplePets_17_SignOut",0);
	} else {
		lr_end_transaction("06_BuyMultiplePets_17_SignOut",1);
	}
...
# 5 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\06_buymultiplepets\\\\combined_06_BuyMultiplePets.c" 2
...
# 6 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\06_buymultiplepets\\\\combined_06_BuyMultiplePets.c" 2
