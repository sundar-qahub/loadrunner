# 1 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\09_loginandlogout\\\\combined_09_LoginAndLogout.c"
...
# 1 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\09_loginandlogout\\\\combined_09_LoginAndLogout.c" 2
...
# 2 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\09_loginandlogout\\\\combined_09_LoginAndLogout.c" 2
...
# 3 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\09_loginandlogout\\\\combined_09_LoginAndLogout.c" 2
...
# 4 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\09_loginandlogout\\\\combined_09_LoginAndLogout.c" 2
...
Action()
{
	...
	if (atoi(lr_eval_string("{01_Count}")) > 0) {
		lr_end_transaction("09_LoginAndLogout_01_Launch", 0);
	} else {
		lr_end_transaction("09_LoginAndLogout_01_Launch", 1);
	}
	...
	if (atoi(lr_eval_string("{02_Count}")) > 0) {
		lr_end_transaction("09_LoginAndLogout_02_EnterTheStore",0);
	} else {
		lr_end_transaction("09_LoginAndLogout_02_EnterTheStore",1);
	}
	...
	if (atoi(lr_eval_string("{03_Count}")) > 0) {
		lr_end_transaction("09_LoginAndLogout_03_ClickSignIn",0);
	} else {
		lr_end_transaction("09_LoginAndLogout_03_ClickSignIn",1);
	}
	...
	if (atoi(lr_eval_string("{04_Count}")) > 0) {
		lr_end_transaction("09_LoginAndLogout_04_ClickLogin",0);
	} else {
		lr_end_transaction("09_LoginAndLogout_04_ClickLogin",1);
	}
	...
	if (atoi(lr_eval_string("{05_Count}")) > 0) {
		lr_end_transaction("09_LoginAndLogout_05_SignOut",0);
	} else {
		lr_end_transaction("09_LoginAndLogout_05_SignOut",1);
	}
	
	lr_think_time(6);
	return 0;
}
# 5 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\09_loginandlogout\\\\combined_09_LoginAndLogout.c" 2
...
# 6 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\09_loginandlogout\\\\combined_09_LoginAndLogout.c" 2
