Action()
{
	...
	if (atoi(lr_eval_string("{01_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_01_Launch",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_01_Launch",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{02_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_02_ClickEnterTheStore",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_02_ClickEnterTheStore",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{03_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_03_ClickSignIn",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_03_ClickSignIn",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{04_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_04_ClickLogin",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_04_ClickLogin",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{05_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_05_ClickPetCats",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_05_ClickPetCats",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{06_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_06_SelectPetProduct",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_06_SelectPetProduct",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{07_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_07_AddToCartPetitem",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_07_AddToCartPetitem",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{08_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_08_updateRandomQuantityAndUpdateCart",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_08_updateRandomQuantityAndUpdateCart",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{09_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_09_ClickProceedToCheckOut",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_09_ClickProceedToCheckOut",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{10_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_10_EnterPaymentAndContinue",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_10_EnterPaymentAndContinue",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{11_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_11_ConfirmOrder",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_11_ConfirmOrder",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{12_Count}")) > 0) {
		lr_end_transaction("02_BuyCats_12_ClickSignout",LR_PASS);
	} else {
		lr_end_transaction("02_BuyCats_12_ClickSignout",LR_FAIL);
	}
