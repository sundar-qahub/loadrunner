# 1 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\03_buyreptiles\\\\combined_03_BuyReptiles.c"
...
# 1 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\03_buyreptiles\\\\combined_03_BuyReptiles.c" 2
...
# 2 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\03_buyreptiles\\\\combined_03_BuyReptiles.c" 2
...
# 3 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\03_buyreptiles\\\\combined_03_BuyReptiles.c" 2
...
# 4 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\03_buyreptiles\\\\combined_03_BuyReptiles.c" 2
...
Action()
{
	...
	if (atoi(lr_eval_string("{01_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_01_Launch",0);
	} else {
		lr_end_transaction("03_BuyReptiles_01_Launch",1);
	}
	...
	if (atoi(lr_eval_string("{02_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_02_ClickEnterTheStore",0);
	} else {
		lr_end_transaction("03_BuyReptiles_02_ClickEnterTheStore",1);
	}
	...
	if (atoi(lr_eval_string("{03_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_03_ClickSignIn",0);
	} else {
		lr_end_transaction("03_BuyReptiles_03_ClickSignIn",1);
	}
	...
	if (atoi(lr_eval_string("{04_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_04_ClickLogin",0);
	} else {
		lr_end_transaction("03_BuyReptiles_04_ClickLogin",1);
	}
	...
	if (atoi(lr_eval_string("{05_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_05_ClickPetReptiles",0);
	} else {
		lr_end_transaction("03_BuyReptiles_05_ClickPetReptiles",1);
	}
	...
	if (atoi(lr_eval_string("{06_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_06_SelectPetProduct",0);
	} else {
		lr_end_transaction("03_BuyReptiles_06_SelectPetProduct",1);
	}
	...
	if (atoi(lr_eval_string("{07_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_07_AddToCartPetitem",0);
	} else {
		lr_end_transaction("03_BuyReptiles_07_AddToCartPetitem",1);
	}
	...
	if (atoi(lr_eval_string("{08_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_08_updateRandomQuantityAndUpdateCart",0);
	} else {
		lr_end_transaction("03_BuyReptiles_08_updateRandomQuantityAndUpdateCart",1);
	}
	...
	if (atoi(lr_eval_string("{09_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_09_ClickProceedToCheckOut",0);
	} else {
		lr_end_transaction("03_BuyReptiles_09_ClickProceedToCheckOut",1);
	}
	...
	if (atoi(lr_eval_string("{10_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_10_EnterPaymentAndContinue",0);
	} else {
		lr_end_transaction("03_BuyReptiles_10_EnterPaymentAndContinue",1);
	}
	...
	if (atoi(lr_eval_string("{11_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_11_ConfirmOrder",0);
	} else {
		lr_end_transaction("03_BuyReptiles_11_ConfirmOrder",1);
	}
	...
	if (atoi(lr_eval_string("{12_Count}")) > 0) {
		lr_end_transaction("03_BuyReptiles_12_ClickSignout",0);
	} else {
		lr_end_transaction("03_BuyReptiles_12_ClickSignout",1);
	}
...
# 5 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\03_buyreptiles\\\\combined_03_BuyReptiles.c" 2
...
# 6 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\03_buyreptiles\\\\combined_03_BuyReptiles.c" 2
