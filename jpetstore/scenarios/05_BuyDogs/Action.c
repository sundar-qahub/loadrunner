Action()
{
	...
	if (atoi(lr_eval_string("{01_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_01_Launch",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_01_Launch",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{02_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_02_ClickEnterTheStore",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_02_ClickEnterTheStore",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{03_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_03_ClickSignIn",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_03_ClickSignIn",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{04_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_04_ClickLogin",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_04_ClickLogin",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{05_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_05_ClickPetDogs",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_05_ClickPetDogs",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{06_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_06_SelectPetProduct",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_06_SelectPetProduct",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{07_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_07_AddToCartPetitem",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_07_AddToCartPetitem",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{08_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_08_updateRandomQuantityAndUpdateCart",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_08_updateRandomQuantityAndUpdateCart",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{09_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_09_ClickProceedToCheckOut",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_09_ClickProceedToCheckOut",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{10_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_10_EnterPaymentAndContinue",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_10_EnterPaymentAndContinue",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{11_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_11_ConfirmOrder",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_11_ConfirmOrder",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{12_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_12_ClickSignout",LR_PASS);
	} else {
		lr_end_transaction("05_BuyDogs_12_ClickSignout",LR_FAIL);
	}
