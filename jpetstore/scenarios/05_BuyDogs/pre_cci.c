# 1 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\05_buydogs\\\\combined_05_BuyDogs.c"
...
# 1 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\05_buydogs\\\\combined_05_BuyDogs.c" 2
...
# 2 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\05_buydogs\\\\combined_05_BuyDogs.c" 2
...
# 3 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\05_buydogs\\\\combined_05_BuyDogs.c" 2
...
# 4 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\05_buydogs\\\\combined_05_BuyDogs.c" 2
...
Action()
{
	...
	lr_start_transaction("05_BuyDogs_01_Launch");
	...
	if (atoi(lr_eval_string("{01_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_01_Launch",0);
	} else {
		lr_end_transaction("05_BuyDogs_01_Launch",1);
	}
	...
	lr_start_transaction("05_BuyDogs_02_ClickEnterTheStore");
	...
	if (atoi(lr_eval_string("{02_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_02_ClickEnterTheStore",0);
	} else {
		lr_end_transaction("05_BuyDogs_02_ClickEnterTheStore",1);
	}
	...
	lr_start_transaction("05_BuyDogs_03_ClickSignIn");
	web_url("3", 
	...
	if (atoi(lr_eval_string("{03_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_03_ClickSignIn",0);
	} else {
		lr_end_transaction("05_BuyDogs_03_ClickSignIn",1);
	}
	...
	lr_start_transaction("05_BuyDogs_04_ClickLogin");
	...
	if (atoi(lr_eval_string("{04_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_04_ClickLogin",0);
	} else {
		lr_end_transaction("05_BuyDogs_04_ClickLogin",1);
	}
	...
	lr_start_transaction("05_BuyDogs_05_ClickPetDogs");
	...
	if (atoi(lr_eval_string("{05_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_05_ClickPetDogs",0);
	} else {
		lr_end_transaction("05_BuyDogs_05_ClickPetDogs",1);
	}
	...
	lr_start_transaction("05_BuyDogs_06_SelectPetProduct");
	...
	if (atoi(lr_eval_string("{06_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_06_SelectPetProduct",0);
	} else {
		lr_end_transaction("05_BuyDogs_06_SelectPetProduct",1);
	}
	...
	lr_start_transaction("05_BuyDogs_07_AddToCartPetitem");
	web_url("7", 
	...
	if (atoi(lr_eval_string("{07_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_07_AddToCartPetitem",0);
	} else {
		lr_end_transaction("05_BuyDogs_07_AddToCartPetitem",1);
	}
	...
	lr_start_transaction("05_BuyDogs_08_updateRandomQuantityAndUpdateCart");
	web_submit_data("8", 
	...
	if (atoi(lr_eval_string("{08_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_08_updateRandomQuantityAndUpdateCart",0);
	} else {
		lr_end_transaction("05_BuyDogs_08_updateRandomQuantityAndUpdateCart",1);
	}
	...
	lr_start_transaction("05_BuyDogs_09_ClickProceedToCheckOut");
	...
	if (atoi(lr_eval_string("{09_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_09_ClickProceedToCheckOut",0);
	} else {
		lr_end_transaction("05_BuyDogs_09_ClickProceedToCheckOut",1);
	}
	...
	lr_start_transaction("05_BuyDogs_10_EnterPaymentAndContinue");
	...
	if (atoi(lr_eval_string("{10_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_10_EnterPaymentAndContinue",0);
	} else {
		lr_end_transaction("05_BuyDogs_10_EnterPaymentAndContinue",1);
	}
	...
	lr_start_transaction("05_BuyDogs_11_ConfirmOrder");
	...
	if (atoi(lr_eval_string("{11_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_11_ConfirmOrder",0);
	} else {
		lr_end_transaction("05_BuyDogs_11_ConfirmOrder",1);
	}
	...
	lr_start_transaction("05_BuyDogs_12_ClickSignout");
	...
	if (atoi(lr_eval_string("{12_Count}")) > 0) {
		lr_end_transaction("05_BuyDogs_12_ClickSignout",0);
	} else {
		lr_end_transaction("05_BuyDogs_12_ClickSignout",1);
	}
...
# 5 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\05_buydogs\\\\combined_05_BuyDogs.c" 2
...
# 6 "c:\\users\\gauth\\loadrunner\\jpetstore\\scenarios\\05_buydogs\\\\combined_05_BuyDogs.c" 2
