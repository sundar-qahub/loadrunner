Action()
{
	...
	if (atoi(lr_eval_string("{01_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_01_Launch",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_01_Launch",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{02_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_02_ClickEnterTheStore",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_02_ClickEnterTheStore",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{03_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_03_ClickSignIn",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_03_ClickSignIn",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{04_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_04_ClickLogin",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_04_ClickLogin",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{05_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_05_ClickPetBirds",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_05_ClickPetBirds",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{06_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_06_SelectPetProduct",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_06_SelectPetProduct",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{07_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_07_AddToCartPetitem",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_07_AddToCartPetitem",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{08_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_08_updateRandomQuantityAndUpdateCart",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_08_updateRandomQuantityAndUpdateCart",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{09_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_09_ClickProceedToCheckOut",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_09_ClickProceedToCheckOut",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{10_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_10_EnterPaymentAndContinue",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_10_EnterPaymentAndContinue",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{11_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_11_ConfirmOrder",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_11_ConfirmOrder",LR_FAIL);
	}
	...
	if (atoi(lr_eval_string("{12_Count}")) > 0) {
		lr_end_transaction("04_BuyBirds_12_ClickSignout",LR_PASS);
	} else {
		lr_end_transaction("04_BuyBirds_12_ClickSignout",LR_FAIL);
	}
